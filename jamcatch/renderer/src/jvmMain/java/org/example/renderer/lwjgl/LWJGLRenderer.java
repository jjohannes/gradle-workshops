package org.example.renderer.lwjgl;

import static java.util.Objects.requireNonNull;
import static org.example.renderer.lwjgl.textures.TextureManagement.saveScreenshot;
...
import org.example.renderer.lwjgl.textures.TextureManagement;
...
public class LWJGLRenderer implements Renderer {
    ...
    private void loop() {
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            List.copyOf(gameState.getSpots()).forEach(this::drawSpot);
            glfwPollEvents();
            glfwSwapBuffers(window);
    ...
    private void drawSpot(Spot s) {
        drawSprite(ensureTexture(s), s.getPixelPositionX(CELL_SIZE), s.getPixelPositionY(CELL_SIZE));
    }
